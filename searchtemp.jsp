...
<div id="right">
			...
			<form id="form2" name="form2" method="get" action="searchtemp1.jsp">
			  <table width="71%" border="2" align="center" cellpadding="2" cellspacing="2">
                <caption>
                  Select ur choice
                </caption>
			    <tr>
			      <th colspan="2" scope="col">Date of Journey
                  <input type="date" name="textfield" required="required" /></th>
		        </tr>
			    <tr>
